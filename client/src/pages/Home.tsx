    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="px-8 pt-28 pb-20 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          {/* Left: Copy */}
          <div>
            <p className="hero-label mb-6 tracking-[0.25em] uppercase text-sm font-medium text-emerald-400/90">Automate mundane. Elevate human.</p>
      ...
      <section id="bottom-cta" className="px-8 py-24 text-center max-w-3xl mx-auto">
        <p className="mb-4 tracking-[0.25em] uppercase text-sm font-medium text-emerald-400/90">Automate mundane. Elevate human.</p>
      ...
      <footer className="px-8 py-16 max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-xs text-emerald-400/70 mt-1 tracking-wider">Automate mundane. Elevate human.</p>
          </div>
